...
if(isset($_COOKIE['folderid'])){
	$url1 = strrpos($_SERVER["HTTP_REFERER"]."uploads", "index.php");
	$url2 = strrpos($_SERVER["HTTP_REFERER"]."uploads", "uploads");
	$url3 = substr($_SERVER["HTTP_REFERER"]."uploads",$url1,$url2);
	$url4 = str_replace($url3, "uploads/", $_SERVER["HTTP_REFERER"]."uploads");
	$opts = array(
		// 'debug' => true,
		'roots' => array(
			array(
				...
				'URL'           => $url4.$_COOKIE['folderid']."/", // URL to files (REQUIRED)
