	...
	<div class="modal-dialog  modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title text-center"><i class="fa fa-cogs"></i> Email notification settings</h4>
			</div>
			<div class="modal-body" id="enable_share_modal_body">                
				<form class="form-horizontal" method="POST" action="<?php echo base_url('fb_msg_manager/notification_settings'); ?>">
					...
					<div class="form-group">
						<label class="control-label col-sm-5">Please select your time zone</label>
						<div class="col-sm-3">
							<?php 
					...
					<div class="form-group">
						<label class="control-label col-sm-5">Do you have FB business manager account ?</label>
						<div class="col-sm-7">
							<?php 
							$check_business = 'no';
							if(!empty($settings_info))
					...
					<div class="form-group">
						<label class="control-label col-sm-5">Do you want to get  email alert for unread messages ?</label>
						<div class="col-sm-7">
							<?php 
							$checking = 'no';
							if(!empty($settings_info))
					...
					<div id="second_part" style="display: none;">
						<div class="form-group">
							<label class="control-label col-sm-5">Time interval for getting email alert</label>
							<div class="col-sm-3">
								<?php 
								$option_array = array(
									'60' => '1 hour',
						...
						<div class="form-group">
							<label class="control-label col-sm-5">Email address to which alert will be sent</label>
							<div class="col-sm-5">
...
<div class="row" style="padding: 10px;">
	<div class="col-xs-12">		
		<div class="well text-center"><h4 class="red"><i class="fa fa-calendar-check-o"></i> <b>Enable Page For Inbox & Notification</b></h4></div>
		<div class="row">
