    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center"><i class="fa fa-wechat"></i> Conversation of <span id="conversation_page_name"></span></h4>
            </div>
            <div class="modal-body" id="conversation_modal_body" style="height: 500px; overflow: auto;">                

            </div>
            <div class="modal-footer">
            	<input class="form-control" type="text" placeholder="type your reply message here" id="reply_message" name="reply_message">
            	<div class='' id="emotion_container"><?php echo $emotion_list;?></div>
            	<button class="btn btn-success btn-sm" id="final_reply_button" style="margin-top: 5px;"><i class="fa fa-send"></i> Send Reply</button>
            </div>
        </div>
    </div>
</div>
