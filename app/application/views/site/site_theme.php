...
<div id="banner" class="banner">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
					...
					<p class="lead text-center">
						Facebook Inboxer is A Revolutionary, World's Very First,Most Powerful and Complete Facebook 
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h1 class="text-center">Really powerful than email marketing !</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section translucent-bg bg-image-2 pb-clear">
		<div class="container object-non-visible" data-animation-effect="fadeIn">
			<h1 id="features" class="title text-center">Features</h1>
			<div class="space"></div>
				...
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Multiple Facebook Account.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Sync Page's Messenger Leads.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Send Bulk Message to Leads</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Auto Sync Lead Everyday.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Multipage Campaign Set option</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Custom Campaign Set Option</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Full Report of Campaign(Delivery/Unsuccessful)</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Custom Message With Individual Leads Name option</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Delay Option For Each Message Send</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Unsubscribe Link Embed Option</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Manual Unsubscribe Option</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Auto Unsubscribe option for Blocked User.</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Auto Private Reply for Post Comment</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Highly Customizable option for your reply text.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Filtering word based reply option</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Full report of auto reply.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Send Message Button for Your Website. </h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">JSON code generation tools for Facebook Messenger Ads</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Message Page CTA Poster</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Facebook Chat Plugin for Website</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Pages Message in one place</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">All unread message in one place.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Reply Option from one place.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Unread Message Information notification to email.</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">All Unread Page Notification in One place. </h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Awesome Dashboard.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Multiuser and SaaS Application</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Paypal/Stripe integrated.</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-4">
					<div class="media testimonial">
						...
						<div class="media-body">
							<h3 class="media-heading">Your user don't need API configuration. </h3>
						</div>
					</div>
				</div>
			</div>
