...
<div class="row padded_row2">
	<h4>			
		<div class="well text-center">
			<i class="fa fa-facebook-official"></i> Video Insight : Page List
		</div>
	</h4>
</div>
	...
	<?php foreach($fb_page_info as $value) : ?>
		<div class="col-xs-12 col-sm-12 col-md-4">
			<div class="content_wrapper">
				...
				<br/>
				<div class="row text-center">
					<button class="btn btn-sm btn-primary synch_video" page_name="<?php echo $value['page_name']; ?>" table_id="<?php echo $value['id']; ?>"><i class="fa fa-retweet"></i> Sync Video</button>
					<a href="<?php echo base_url('facebook_rx_insight/video_list_grid/'.$value['id']); ?>" class="btn btn-sm btn-info"><i class="fa fa-th-large"></i> Video List</a>
				</div>
			</div>
		</div>
	<?php endforeach; ?>
...
<script>
	...
	$j(document).ready(function(){
		...
		$(".synch_video").click(function(){
			var ans = confirm("Do you want to sync videos for this page?");
			if(ans)
			{
    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center"><i class="fa fa-spinner"></i> Sync videos for page - <span id="page_name_div"></span></h4>
            </div>
