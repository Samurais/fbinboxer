	...
	<div class="col-xs-12 col-md-6 padding-5">
		<div class="box box-primary">
			<div class="box-header ui-sortable-handle" style="cursor: move;">
				...
				<h3 class="box-title">CTA (Call to Action) Poster</h3>
				<!-- tools box -->
			...
			<div class="box-body">
				<form action="#" enctype="multipart/form-data" id="cta_poster_form" method="post">
					...
					<div class="form-group cta_value_container_div">
						<label>CTA button action link</label>
					...
					<div id="like_comment_Share_reply_block" style="margin-top:30px !important" class="<?php echo $like_comment_Share_reply_block_class;?>">
						<div class="form-group">
							<label>Auto share this post</label><br/>
						...
						<div class="form-group auto_share_post_block_item">
							<label>Auto share to timeline</label><br/>
						...
						<div class="form-group auto_share_post_block_item">
							<label>Auto share as pages</label>
						...
						<div class="form-group">
							<label>Auto like this post as all other pages</label><br/>
						...
						<div class="form-group">
							<label>Auto private reply on user comments</label><br/>
					...
					<div class="box-footer clearfix">
						<button class="btn btn-primary" submit_type="text_submit" id="submit_post" name="submit_post" type="button"><i class="fa fa-send"></i> Submit Post </button>
					</div>
