...
<div class="">
  <div class="col-xs-12">       
    <div class="well">
      <h4 class="text-center blue"> <i class="fa fa-facebook-official"></i> Import Lead(s) : Page List<h4>
    </div>
  </div>
</div>
          ...
          <div class="col-xs-12">
            <div class="row">
              ...
              <div class="text-center col-xs-12 col-md-4">
                ...
                <br/>
                <span class="label label-success">Subscribed : 
                   <?php 
                ...
                <br/>
                <span class="label label-warning">Unsubscribed : 
                   <?php 
              ...
              <div class="col-xs-12 col-md-8">
                ...
                <div class="sync_page_style text-center">
                  <span class="info-box-text">
                    <button id ="<?php echo $value['id'];?>" type="button" style='width:45%;' class="pull-left btn-sm btn btn-primary import_data"><i class="fa fa-retweet"></i> Scan page inbox</button>
                    <?php 
                        if(!empty($value['current_lead_count'])) $is_hidden = "";
                        else $is_hidden = "hidden";
                        echo "<button id ='".$value['user_id']."-".$value['page_id']."' style='width:45%;' type='button' class='".$is_hidden." btn-sm user_details_modal btn btn-info pull-right'><i class='fa fa-list'></i> Lead list</button>";
                    ?>
                  </span>
                </div>               
              </div>                  
              ...
              <div class="col-xs-6 clearfix"> 
               ...
               <div class="col-xs-6">                
                  <div class="pull-right">
                    <?php 
                    echo "<i class='fa fa-clock-o'></i> Last scanned  <br/>";
                    ...
                    else echo "<span style='font-weight:normal;' class='label label-warning'>Never scanned</span>";
                  ?>
                  </div>
              </div>
    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-user"></i> Lead List</h4>
            </div>
