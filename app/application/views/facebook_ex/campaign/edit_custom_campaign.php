	...
	<div class="col-xs-12 col-md-7 padding-10">
		<div class="box box-primary">
			<div class="box-header ui-sortable-handle  text-center" style="cursor: move;margin-bottom: 0px;">
				...
				<h3 class="box-title">Edit Custom Campaign</h3>
				<!-- tools box -->
				...
				<form action="#" enctype="multipart/form-data" id="inbox_campaign_form" method="post">
					...
					<div class="form-group">
						...
						<span class='pull-right'> 
							<a href="#" data-placement="top"  data-toggle="popover" data-trigger="focus" title="Include lead user name"" data-content="You can include #LEAD_USER_NAME# variable inside your message. The variable will be replaced by real names when we will send it."><i class='fa fa-info-circle'></i> </a> 
							<a id="lead_name" title="Include lead user name" class='btn btn-default btn-sm'><i class='fa fa-user'></i> Include "Lead User Name"</a>
						</span>
