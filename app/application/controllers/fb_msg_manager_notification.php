...
class fb_msg_manager_notification extends Home
{
    ...
    public function get_pages_notification()
    {
        ...
        else
        {
            ...
            $str .= '<h3 class="red refresh_button_holder"><div class="well text-center clearfix"><i class="fa fa-bullhorn"></i> Notifications of inbox manager enabled pages<button id="refresh_button_notification" class="btn btn-success pull-right"><i class="fa fa-refresh"></i> Refresh Data</button></div></h3>';

            foreach($page_list as $value)
            {
                $str .= '<div class="well text-center"><h3 class="header_title"><img class="img-thumbnail" src="'.$value['page_profile'].'" alt="image"> '.$value['page_name'].' - Notifications</h3></div>';
